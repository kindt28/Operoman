	...
	var Datepicker = function () {
	    ...
	    _createClass(Datepicker, [{
	        ...
	        value: function renderButton(actionType, className) {
	            ...
	            //var newObject = $.extend({ actionType: actionType, className: className },new _Button2.default());
	            //return this.config.templates.button(newObject);
	        }
...
/***/ function(module, exports) {
	...
	var MONTHS = exports.MONTHS = ['1 月', '2 月', '3 月', '4 月', '5 月', '6 月', '7 月', '8 月', '9 月', '10 月', '11 月', '12 月'];
	
	var DAYS = exports.DAYS = ['日', '月', '火', '水', '木', '金', '土'];
